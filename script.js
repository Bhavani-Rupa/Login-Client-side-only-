/*
  ...
  This file makes the page interactive. It:
  - Shows friendly pop-up messages (alerts)
  - Checks how strong a password is
  - Lets you show/hide the password
  - Checks that each form field is filled out correctly
  - Pretends to do social logins and shows success messages
  - Handles what happens when you submit the form

  You do not need to be technical to follow the comments below.
*/

// Custom Alert System: shows a small message box on the screen
...
// Picks a nice icon for the alert based on message type
...
// Password Strength Checker: tells you if your password is weak or strong
...
// Toggle Password Visibility: lets you see or hide the password text
...
// Form Validation: checks if a field looks okay and shows a red message if not
...
// Validation Rules: simple checks and friendly error messages for each field
...
// Social Login Functions: pretend buttons that just show success messages
...
// Additional Functions: links that show helpful messages for demo purposes
...
// PAGE SETUP: runs after the page loads and wires up all the interactions
document.addEventListener('DOMContentLoaded', function() {
    showAlert('Welcome to our registration system!', 'info', 3000);
    

    // Real-time validation: checks fields while you type or leave a field
    ...
    // Password strength monitoring: updates the colored bar as you type
    ...
    // Form Submission: what happens when you press Create Account
    ...
    if (registrationForm) {
        registrationForm.addEventListener('submit', function(event) {
            ...
            // Validate all fields: if something is wrong, we show a message
            Object.keys(validationRules).forEach(fieldId => {
                const field = document.getElementById(fieldId);
            ...
            // Get form values: collect what you typed so we can show it back to you
            const formData = {
            ...
            // Clear form: wipe everything so it looks fresh again
            this.reset();
            
            // Remove validation classes: remove green/red styling from fields
            document.querySelectorAll('.form-control').forEach(field => {
                field.classList.remove('is-valid', 'is-invalid');
            });
            
            // Reset password strength: set the bar and text back to default
            const strengthBar = document.getElementById('passwordStrength');
            const strengthText = document.getElementById('strengthText');
